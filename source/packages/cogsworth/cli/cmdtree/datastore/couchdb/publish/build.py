...
HELP_RESULTS = "A folder containing build results to publish"
...
def command_datastore_couchdb_publish_build(host: str, port: int, username: str, password: str, results, expiry_days):
    ...
    from cogsworth.xmods.xdatetime import FORMAT_DATETIME
    from cogsworth.cogsw.jsos import load_jsos_stream_from_file
